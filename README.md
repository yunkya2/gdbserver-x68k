...
* [elf2x68k](https://github.com/yunkya2/elf2x68k) 20250726 以降のバージョンの libpthread を用いたマルチスレッドプログラムのデバッグが可能です
  * 20250712 バージョンの libpthread は gdbserver からのデバッグに対応していないため、20250726 以降のバージョンを使用してください
